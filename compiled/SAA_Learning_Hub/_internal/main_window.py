...
from course_parser import Section, Lesson, get_all_lessons_flat
...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        video_page_layout.setSpacing(6)
